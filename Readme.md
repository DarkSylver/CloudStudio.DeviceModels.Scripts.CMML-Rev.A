...
# Parsing + Configuration Script – CM_ML - Rev. A

This **Parsing + Configuration** script is designed for the **CM_ML** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – CM_ML Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **CM_ML** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
